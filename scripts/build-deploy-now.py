...
LOCALIZED_PAGES = {
    ...
    "fr": {
        ...
        "replacements": {
            ...
            "作図は無料。<br><em>広告非表示は一度だけ。</em>": "Dessinez gratuitement.<br><em>Supprimez les pubs une seule fois.</em>",
            "すべての作図機能を無料で使えます。気に入って使い続けるときだけ、500円の買い切りでバナー広告を非表示にできます。": "Toutes les fonctionnalités de dessin sont gratuites. Un achat unique supprime définitivement les publicités.",
            "買い切り / 自動更新なし": "Achat unique / Sans abonnement",
            "作図・保存・共有は無料": "Dessiner, enregistrer et partager gratuitement",
            ...
            "80 beads": "80 perles",
            "2 colors": "2 couleurs",
            "Peyoは、ペヨーテステッチのビーズ図案を指で描き、色ごとのビーズ数を自動で数えられるiPhoneアプリです。作図は無料、広告非表示は500円の買い切りです。": "Peyo est une app pour iPhone et iPad qui permet de dessiner des motifs de perles pour le point peyote et de les compter par couleur. Tous les outils de dessin sont gratuits ; un achat unique supprime les publicités.",
