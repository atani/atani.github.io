    ...
    "match-notebook": {
        ...
        "locales": {
            "ja": {
                ...
                "meta": "iPhone・iPad対応 / 登録不要 / 広告なし / 端末内に保存",
                ...
                "price_body": "対戦相手5人・試合20件まで無料。子ども本人が続けたいと思ったら、保護者は¥1,500のLifetime買い切りで記録を無制限にできます。自動更新はありません。",
                "price_points": ["広告・アカウント・サーバー不要", "試合後の気づきを端末内に保存", "一度の購入で自動更新なし"],
                "proof_items": ["実際のApp Store用スクリーンショット", "5人・20試合まで無料", "広告なし・アカウント不要"],
                "cta": "App Storeで見る",
            ...
            "en": {
                ...
                "meta": "For iPhone & iPad / No account / No ads / Stored on device",
                ...
                "price_title": "5 opponents and 20 matches free.<br><em>One Lifetime purchase.</em>",
                "price_body": "Free for up to 5 opponents and 20 matches. A one-time Lifetime purchase unlocks unlimited records, with no auto-renewal. Your local price is shown by the App Store.",
                "price_points": ["No ads, account, or developer-run server", "Your match notes stay on your device", "One purchase with no auto-renewal"],
                "proof_items": ["Real App Store screenshots", "5 opponents and 20 matches free", "No ads or account required"],
