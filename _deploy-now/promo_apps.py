    ...
    "match-notebook": {
        ...
        "locales": {
            "ja": {
                ...
                "kicker": "子どもから大人まで使える対戦相手ノート",
                "headline": "前回効いた作戦を、<em>次の試合で忘れない。</em>",
                "lead": "部活・クラブ・大会で残した弱点、効いたこと、避けること。選手本人が、再戦前に前回の気づきを30秒で思い出せます。",
                "meta": "iPhone・iPad対応 / 登録不要 / 記録は端末内に保存",
                "hero_alt": "Match Notebookの次の試合画面",
                "section_kicker": "試合のあとに残す",
                "section_title": "スコアだけでは残らない、<em>次の一手のための記録。</em>",
                "features": [
                    ("対戦相手を記録", "弱点、対戦成績、試合日を相手ごとにまとめる。記録は端末内に保存します。"),
                    ("効いた作戦を残す", "最初の作戦、前回効いたこと、避けることを一画面に。"),
                    ("記録は広告と分離", "対戦相手名・スコア・メモ・作戦を広告ネットワークへ渡しません。"),
                ],
                "gallery_title": "実際の画面で見る、<em>Match Notebook。</em>",
                "gallery_alts": ["次の試合と対戦相手の記録", "試合後の気づき入力", "対戦相手の戦績と作戦カード", "対応スポーツ一覧", "プライバシー設定"],
                "price_kicker": "無料 + 選べるPremium",
                "price_title": "無料で記録を始めて、<br><em>Premiumで広告なし・無制限。</em>",
                "price_body": "無料版は対戦相手5人・試合20件まで使え、対象となる試合の保存後に控えめな広告が表示される場合があります。広告は全年齢向け・非パーソナライズです。Premiumはすべての広告を非表示にし、対戦相手と試合を無制限に記録できます。Appleの表示価格と条件が優先されます。",
                "price_points": ["年額プラン ¥2,400 / 年（自動更新）", "買い切りプラン ¥5,500 / 一括購入", "月額プラン ¥300 / 月（自動更新）"],
                "proof_items": ["記録は端末内に保存", "全年齢向け・非パーソナライズ広告", "Premiumは広告なし・記録数無制限"],
                "cta": "App Storeで見る",
            ...
            "en": {
                ...
                "kicker": "Opponent notes for junior and adult athletes",
                "headline": "Remember what worked.<br><em>Win the rematch.</em>",
                "lead": "Keep weaknesses, winning patterns, and what to avoid in one place—then let the athlete review the next strategy before the match.",
                "meta": "For iPhone & iPad / No account / Records stay on device",
                ...
                "features": [
                    ("Know every opponent", "Keep weaknesses, head-to-head results, and match dates together. Records stay on your device."),
                    ("Save the strategy", "Record your opening plan, what worked, and what to avoid."),
                    ("Records stay out of ads", "Opponent names, scores, notes, and strategies are never sent to ad networks."),
                ],
                ...
                "price_kicker": "Free + flexible Premium",
                "price_title": "Start recording for free.<br><em>Go ad-free and unlimited with Premium.</em>",
                "price_body": "Free includes up to 5 opponents and 20 matches. A modest ad may appear after an eligible match save. Ads are general-audience and non-personalized. Premium removes every ad and unlocks unlimited opponent and match records. Apple’s displayed price and terms are authoritative.",
                "price_points": ["Annual plan — $14.99 / year (auto-renewing)", "Lifetime plan — $34.99 one-time purchase", "Monthly plan — $1.99 / month (auto-renewing)"],
                "proof_items": ["Records stay on your device", "General-audience, non-personalized ads", "Premium means no ads and unlimited records"],
    ...
    "sports-photographer-helper": {
        ...
        "locales": {
            "ja": {
                ...
                "meta": "iPhone対応 / 登録不要 / 撮影プラン3件まで無料",
                ...
                "support": "https://atani.github.io/sportsphotographerhelper-legal/",
                "price_kicker": "無料 + 選べるPro",
                "price_title": "まず3プランを無料で。<em>続けるなら、選べるPro。</em>",
                "price_body": "無料版は撮影条件の提案と3件までの保存に対応し、保存成功後に広告が表示される場合があります。Proは広告なし・保存無制限・設定の複製・機材プリセット・PDF共有を解放。月額¥500、年額¥2,500（対象者は3日間無料）、買い切り¥2,500から選べます。Appleの表示価格と条件が優先されます。",
                "price_points": ["月額Pro ¥500・無料トライアルなし", "年額Pro ¥2,500・対象者は3日間無料", "買い切りPro ¥2,500・自動更新なし"],
                "cta": "App Storeで見る",
                "footer": "撮影前の準備を始める",
            },
            "en": {
                ...
                "meta": "For iPhone / No account / Three saved plans free",
                ...
                "support": "https://atani.github.io/sportsphotographerhelper-legal/",
                "price_kicker": "Free + flexible Pro",
                "price_title": "Try three plans free.<br><em>Choose the Pro plan that fits.</em>",
                "price_body": "Free includes camera guidance and up to three saved plans; an ad may appear only after a successful save. Pro removes post-save ads and unlocks unlimited saves, plan copying, equipment presets, and PDF sharing. Choose Monthly Pro at ¥500 with no trial, Annual Pro at ¥2,500 with a 3-day trial for eligible customers, or Lifetime Pro at ¥2,500. Apple’s displayed price and eligibility are authoritative.",
                "price_points": ["Monthly Pro ¥500 with no free trial", "Annual Pro ¥2,500 with an eligible 3-day trial", "Lifetime Pro ¥2,500 with no auto-renewal"],
                "cta": "View on the App Store",
    ...
    "chillcast": {
        ...
        "locales": {
            ...
            "es": {
                ...
                "price_title": "Comprueba la temporada gratis.<br><em>Pro: pago único de 9,99 €.</em>",
            ...
            "tr": {
                ...
                "price_title": "Sezonu ücretsiz kontrol edin.<br><em>Pro tek seferlik 499,99 ₺.</em>",
    ...
    "leafmark": {
        ...
        "locales": {
            ...
            "en": {
                "lang": "en",
                "label": "English",
                "store": "https://apps.apple.com/us/app/id6781045740",
    ...
    "dotto": {
        ...
        "locales": {
            ...
            "en": {
                "lang": "en",
                "label": "English",
                "store": "https://apps.apple.com/us/app/id6782310741",
            ...
            "de": {
                "lang": "de",
                "label": "Deutsch",
                "store": "https://apps.apple.com/de/app/id6782310741",
